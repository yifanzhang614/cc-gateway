...
public class SimplePrincipalCollection implements MutablePrincipalCollection {
    ...
    public void addAll(PrincipalCollection principals) {
        if (principals.getProviderNames() != null) {
            for (String realmName : principals.getProviderNames()) {
                for (Object principal : principals.fromProvider(realmName)) {
                    add(principal, realmName);
                }
            }
        }
    ...
    public Collection fromProvider(String realmName) {
        if (realmPrincipals == null || realmPrincipals.isEmpty()) {
            return Collections.EMPTY_SET;
        }
        Set principals = realmPrincipals.get(realmName);
    ...
    private void writeObject(ObjectOutputStream out) throws IOException {
        ...
        boolean principalsExist = !MapUtils.isEmpty(realmPrincipals);
